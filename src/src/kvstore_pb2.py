...
_LOGENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='log', full_name='kvstore.LogEntry.log', index=1,
...
_LOGENTRY.fields_by_name['log'].message_type = _PUTREQUEST
